...
import { Plus, FileText, Calendar, MoreVertical, Eye, Edit2, Trash2, LogOut, Menu, X } from "lucide-react"
...
const Dashboard = () => {
  ...
  return (
    <div className="min-h-screen bg-background flex">
      ...
      {/* Side Menu */}
      <aside
        className={`fixed sm:static top-0 left-0 h-screen w-64 bg-gray-800 text-white flex flex-col transform ${isMenuOpen ? "translate-x-0" : "-translate-x-full"
