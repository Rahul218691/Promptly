...
const FormBuilder = () => {
  ...
  const addField = (type: FormField['type']) => {
    const newField: FormField = {
      ...
      required: false,
      options: type === 'select' || type === 'radio' || type === 'checkbox' ? [] : undefined, // Initialize options as an empty array for applicable types
    }
  ...
  const updateFieldOptions = (fieldId: string, options: string[]) => {
    ...
    if (fieldIndex !== -1) {
      updatedSteps[currentStep].fields[fieldIndex].options = options
      setSteps(updatedSteps)
    }
  }
  ...
  return (
    <div className="min-h-screen bg-background">
      <div className="border-b bg-card fixed top-0 left-0 w-full z-50 shadow-md">
                                      ...
                                      <div key={index} className="flex items-center gap-2">
                                        <Input
                                          ...
                                          onChange={(e) => {
                                            ...
                                            updateFieldOptions(field.id, updatedOptions)
                                          }}
                                          className="flex-1"
                                        />
                                        <Button
